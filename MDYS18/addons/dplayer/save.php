...
if(filter_has_var(INPUT_POST, "player_logo_url")){
	...
	$player['aes']['status'] = filter_input(INPUT_POST, "player_aes_status");
	...
	$pre['trysee']['status'] = filter_input(INPUT_POST, "pre_trysee_status");
	$pre['trysee']['time'] = filter_input(INPUT_POST, "pre_trysee_time");
